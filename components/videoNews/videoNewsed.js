      ...
      <div className={styles.fullheight}>
        <div className={styles.header}>
          ...
          <div className={`${styles.icon} ${styles.facebook}`}>
            ...
            <Icon style={{height:"31px", width:"38px", marginTop:"10%"}} icon={facebookFill} className={styles.facebookicon} />
           
          </div>
          <div className={`${styles.icon} ${styles.twitter}`}>
          
          <Icon style={{height:"31px", width:"38px", marginTop:"10%"}} icon={twitterIcon} className={styles.twitterIcon} />
        ...
        <div className={styles.videoborder}>
          <video src={process.env.NEXT_PUBLIC_API_URL + videoSrc} height="200" width="500" autoPlay controls disablePictureInPicture playsInline controlsList="nodownload" />
        </div>
      </div>
      ...
      <div className={styles.footer}>
        <div className={styles.datarecord}>
          ...
          <div className={styles.subfooter}>
            ...
            <div className={styles.sudata}><TimeAgo timestamp={`${recived.CreatedDate}`} /></div>
